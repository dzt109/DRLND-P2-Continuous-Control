...
# env = UnityEnvironment(file_name='./Reacher_Linux_20/Reacher.x86_64', worker_id=model_num)
env = UnityEnvironment(file_name='./Reacher_Linux_NoVis_20/Reacher.x86_64', worker_id=model_num)
# env = UnityEnvironment(file_name='./Crawler_Linux/Crawler.x86_64', worker_id=int(f'3{model_num}'))
# env = UnityEnvironment(file_name='./Crawler_Linux_NoVis/Crawler.x86_64', worker_id=int(f'3{model_num}'))
